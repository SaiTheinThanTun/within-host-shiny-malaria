...
shinyUI(fluidPage(
  ...
  fluidRow(
    ...
    column(3,
      ...
      sliderInput("killrate", "Kill rate, drug A: ", min = 0, max = .4, value = .2, step = .01),
      ...
      sliderInput("h_2", "h, drug B: ", min = 1, max = 10, value =4, step =1)
      ),
      column(3,
      #drug3
      ...
      sliderInput("h_3", "h, drug C: ", min = 1, max = 10, value =4, step =1)
      )
     ),
